...
@pytest.mark.parametrize(
    "text, for_model, config, with_overlap, max_chunk_length, expected_chunks",
    [
        (
        ...
        (
            "This is a longer test sentence that exceeds the maximum length.",
            "gpt2",
            Config(),
            True,
            None,
            [
                ...
                ("that exceeds the maximum length.", 6),
            ],
        ),
        (
            "This is a test sentence.",
...
def test_split_text(
    ...
    chunks = list(
        split_text(text, for_model, config, with_overlap, max_chunk_length)
    )
