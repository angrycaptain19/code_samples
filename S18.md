...
Removed the check for Real type in the __init__ method and directly stacked the concentration parameters.
Simplified the concentration1 and concentration0 properties to directly access the corresponding values from _dirichlet.concentration.
```
